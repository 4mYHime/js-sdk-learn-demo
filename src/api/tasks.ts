...
export const TOKENS = {
  ...
  presigned_upload: 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFlNGZkZTBhLWUzZWItNGRkYi1iYWEzLTg0MzY3MzcyZmQ2ZSJ9..Vc5VrMXoGZqpNYEK1Td6BVjOe4FOda5jF4K2DOW4buEVvHVyWWHtOgfsqgXUmAE5aSv9Pscgf36aMgGjsjDecnAz724r4dtBGfwCuctk7u0r9v6t7Sp7HYTAJx2ImbleLjY2vpQGd6alL3iEwkWhdqkcD91vZLj43lvTMJGA6XneVSlBdv4Rl6E8z9t1BQJweysAnnSEnO6cdiyqQArhWrjq2QhXwW9us31x05P7-zJIBiybMbLRQmeC63S-nv1MuGJh-bUMJsLs-iqM6nHfXy4ItgJuhd7AqWHAkvvHRZiO8Ni0oJ2wwUospp7P0YPZO0Ge8pZ39tHGPURwxj8qyg',
  upload_report: 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImVmZDA2MDM2LWE5MjYtNDJkNi1hNzA3LTQzYzQ5NDc1Y2JkOCJ9..ViITcbs_vmt9dq2Y1GmOoqDx73vWuR5RGeVXiDircUXEWPXUZAedmPZC7ydh5dyqoq30JEfmV7_qypMerFIp5D_vYnbA80bIFnhCA62Itos9zJrNrq3VOtzJGhZBxaRQ9iAHtxACiE_LCg9_iBScArFdfQ2-DTioYtOvxe6gBNgLj7bFsndpxgfmM2auHRFkPL97Vamx-CXpRWGZIxu6e8NUyikWNrcHoifwq0BsniH6E0tQrtIt8jpMjO7i30n8JaAnNdLjzWFu8kI3FGfzjepX_IMNmfyPVhtg3-cY6F6xhifxJEu9MeQD73gJ1P63DtODXpQzSX7_zTr5uOQEbw'
};
...
// 获取预签名上传URL
export async function getPresignedUploadUrl(request: IPresignedUploadRequest): Promise<IPresignedUploadResponse> {
  const response = await axios.post('/api/presigned_upload/run', request, {
    headers: {
      'Authorization': `Bearer ${TOKENS.presigned_upload}`,
      'Content-Type': 'application/json'
    }
  });
  const data = response.data;
...
// 汇报本地文件上传结果
export async function reportUploadResult(request: IUploadReportRequest): Promise<IUploadReportResponse> {
  const response = await axios.post('/api/upload_report/run', request, {
    headers: {
      'Authorization': `Bearer ${TOKENS.upload_report}`,
      'Content-Type': 'application/json'
    }
  });
  return response.data;
